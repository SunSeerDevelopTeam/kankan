...
(function(TextMessage) {
	...
	TextMessage.branchnumberText = language ? "支店番号を半角数字3桁で入力してください。" : "请用半角数字输入3位的分店号";
	TextMessage.accountnumberText = language ? "口座番号を半角数字3桁で入力してください。" : "请用半角数字输入7位的银行卡号";
	...
	/*TextMessage.transStop = language ? "取引を中止する" : "交易终止";*/
	TextMessage.transactionStop = language ? "取引中止" : "交易终止";
...
/*transfer application*/
    ...
    TextMessage.donate3 = language ? "WWFジャパン" : "WWF Japan";
    TextMessage.donate4 = language ? "日中技能者交流センター" : "日中技能者交流中心";
    TextMessage.donate5 = language ? "日中友好会館" : "日中友好会館";
    TextMessage.donate6 = language ? "中国帰国者・日中友好の会" : "中国归国者·日中友好之会";
    TextMessage.donate7 = language ? "国際交流基金日中交流センター" : "日本国际交流基金会日中交流中心";
...
//filter some sensitive words
var language = navigator.language;
function filterText(filterText) {
	var keyWords = ["﻿安眠酮","代血浆","普萘洛尔","呋塞米","西布曲明","testosterone","胰岛素样生长因子","促红细胞生成素","地西泮","尼可刹米","甲睾酮","adrenaline","erythropoietin","地奈德","莫达非尼","氯噻嗪","苯巴比妥","促性腺激素","泼尼松","麻黄草","雄烯二醇","地塞米松","tamoxifen","strychnine","androst","新型毒品","杜冷丁","兴奋剂","mdma","海洛因","海luo因","heroin","diamorphine","diacetylmorphine","鸦片","阿芙蓉","咖啡因","cocain","三唑仑","美沙酮","麻古","k粉","凯他敏","ketamine","冰毒","苯丙胺","cannabis","大麻","爱他死","氯胺酮","benzodiazepines","甲基安非他明","安非他命","吗啡","morphine","摇头丸","迷药","乖乖粉","narcotic","麻醉药","精神药品","爱女人","爱液","按摩棒","拔出来","爆草","包二奶","暴干","暴奸","暴乳","爆乳","暴淫","屄","被操","被插","被干","逼奸","插暴","操逼","操黑","操烂","肏你","肏死","操死","操我","厕奴","插比","插b","插逼","插进","插你","插我","插阴","潮吹","潮喷","赤裸","抽插","扌由插","抽一插","春药","大波","大力抽送","大乳","荡妇","荡女","盗撮","多人轮","发浪","放尿","肥逼","粉穴","封面女郎","风月大陆","干死你","干穴","肛交","肛门","龟头","裹本","国产av","好嫩","豪乳","黑逼","后庭","后穴","虎骑","花花公子","换妻俱乐部","黄片","几吧","鸡吧","鸡巴","鸡奸","寂寞男","寂寞女","妓女","激情","集体淫","奸情","叫床","就去日","巨屌","菊花洞","菊门","巨奶","巨乳","菊穴","开苞","口爆","口活","口交","口射","口淫","裤袜","狂操","狂插","浪逼","浪妇","浪叫","浪女","狼友","聊性","流淫","铃木麻","凌辱","漏乳","露b","乱交","乱伦","轮暴","轮操","轮奸","裸陪","买春","美逼","美少妇","美乳","美腿","美穴","美幼","秘唇","迷奸","密穴","蜜穴","蜜液","摸奶","摸胸","母奸","奈美","奶子","男奴","内射","嫩逼","嫩女","嫩穴","捏弄","女优","炮友","砲友","喷精","屁眼","品香堂","前凸后翘","强暴","强奸","情趣用品","情色","拳交","全裸","群交","惹火身材","人妻","人兽","日逼","日烂","肉棒","肉逼","肉唇","肉洞","肉缝","肉棍","肉茎","肉具","揉乳","肉穴","肉欲","乳爆","乳房","乳沟","乳交","乳头","三级片","骚逼","骚比","骚女","骚水","骚穴","色逼","色界","色猫","色盟","色情网站","色区","色色","色诱","色欲","色b","少年阿宾","少修正","射爽","射颜","食精","释欲","兽奸","兽交","手淫","兽欲","熟妇","熟母","熟女","爽片","爽死我了","双臀","死逼","丝袜","丝诱","松岛枫","酥痒","汤加丽","套弄","体奸","体位","舔脚","舔阴","调教","偷欢","偷拍","推油","脱内裤","文做","我就色","无码","舞女","无修正","吸精","夏川纯","相奸","小逼","校鸡","小穴","小xue","写真","性感妖娆","性感诱惑","性虎","性饥渴","性技巧","性交","性奴","性虐","性息","性欲","胸推","穴口","学生妹","穴图","亚情","颜射","阳具","杨思敏","要射了","夜勤病栋","一本道","一夜欢","一夜情","一ye情","阴部","淫虫","阴唇","淫荡","阴道","淫电影","阴阜","淫妇","淫河","阴核","阴户","淫贱","淫叫","淫教师","阴茎","阴精","淫浪","淫媚","淫糜","淫魔","淫母","淫女","淫虐","淫妻","淫情","淫色","淫声浪语","淫兽学园","淫书","淫术炼金士","淫水","淫娃","淫威","淫亵","淫样","淫液","淫照","阴b","应召","幼交","幼男","幼女","欲火","欲女","玉女心经","玉蒲团","玉乳","欲仙欲死","玉穴","援交","原味内衣","援助交际","张筱雨","招鸡","招妓","中年美妇","抓胸","自拍","自慰","作爱","18禁","a片","g片","h动画","h动漫","xing伴侣","tokyohot","大麻","你老母","你母","素人","毛片","担保","吹喇叭","高丽棒子","AV","SB","FUCK","Fuck","fuck","NMD","SM","TMD","bitch","cmd","sex","shit","部落","特殊部落","人非人","家柄","血筋	","身分","身元調査	","過去帳","興信所","特殊学級","めくら	","つんぼ","あきめくら","どもり","びっこ","ちんば","いざり","かたわ","がちゃ目","ロンパリ","斜視","業病","かさっかき","植物人間","白痴","のうまくえん","きちがい","きちがいに刃物","きちがい沙汰","狂気の沙汰","天才と狂人は紙一重","マニア","しらっこ","せむし","みつくち","台湾ハゲ","馬鹿","めくら判","つんぼ桟敷","きこえないところ","めくら縞","めくら滅法","めくら蛇におじず","片手落ち","てんぼう","バカチョンカメラ","自閉症児","精神薄弱児","心身障害者","知恵の遅れている子供","犬殺し","おわい屋","クズ屋","バタ屋","ゴミ屋","おんぼう","屠殺","屠殺人","屠殺場","番太","おまわり","運ちゃん","沖仲仕","かつぎ屋","給仕","漁夫","芸人	","周旋屋","下女","下男","女中","百姓","どん百姓","工夫","土方","土工","人足","人夫","鉱夫・坑夫","小使い","雑役夫","三助","女給","女工","職工","線路工夫","日雇い","ニコヨン","坊主","親方","小僧","丁稚","土建屋","タケノコ医者","ヤブ医者","町医者","床屋","代書屋","共稼ぎ","馬丁","馬喰","郵便屋","潜水夫","板前","くろんぼ","ニガー","ニグロ","アメ公","イタ公","ロスケ","ジャップ","チャンコロ","支那人","ジュー","ポコペン","毛唐","紅毛人","鮮人","半島人","南鮮","北鮮","中共","土人","後進国","ダッチマン","あいのこ","移民","支那チク","支那料理","支那そば","日本のチベット","三韓征伐","朝鮮征伐","トルコ風呂","トルコ嬢","老婆","裏日本","表日本","田舎","出戻り","オールドミス","ナオン","情婦","あらめん","まえつき","ほんぼし","ペイ患","おとしまえ","やばい","ジャリ","子供","ずらかる","ブタ箱","コロシ","タタキ","強姦","あて馬","ネコババ","イカサマ","股にかける","くわえこむ","足を洗う","インチキ","アオカン","すけこまし","土左衛門","ゲンナマ","ザギン","チャリンコ","かわかぶり","ゲーセン","ズージャー","せんずり","ヤー様","地まわり","やさぐれ","やくざ","淫売","姦通","パクる","南部のシャケの鼻まがり","越後の米つき","富山の三助","上方のぜい六","伊勢こじき","いちゃもんをつける","うんこ","女子供","婿をとる","嫁にやる","娘をかたづける","しりぬぐい","たれ流し","足切り","首切り","落ちこぼれ","溺れ死ぬ","溺れて死ぬ","本腰を入れる","名門校","まやく","マヤク"];
	for (var i=0;i<keyWords.length;i++) {
		if (filterText.indexOf(keyWords[i]) !== -1) {
			if (language == 'ja-JP' || language == 'ja-jp') {
				alert("不適切な内容がありますので、ご修正ください。");
				return;
			} else if (language=="zh-CN" || language=="zh-cn" || language=="zh-tw" || language=="zh-hk" || language=="zh-TW" || language=="zh-HK") {
				alert("您输入的内容中有不良内容，请修改后再提交");
				return;
			}
		}
	}
