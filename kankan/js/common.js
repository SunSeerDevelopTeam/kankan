...
(function(TextMessage) {
	...
	TextMessage.contentlength = language ? "レビューの内容(300字以内)" : "评论内容（不超过三百字）";
	...
	TextMessage.commodity_descriptionlength = language ? "商品説明(必須：1000文字まで)" : "商品说明（必须:1000字以内）";
	...
	TextMessage.errorCode_2016 = language ? "問い合わせ済みの商品です。": "该商品正在问合中，不能重复提交请求";
	...
	TextMessage.pro_descriptiontest = language ? "商品説明を入力してください" : "商品描述不能为空";
	...
	TextMessage.pro_logininfo = language ? "出品が完了しました" : "出品成功";
	...
	TextMessage.sendtextrequest = language ? "宛にメールを送りますか" : "发送电子邮件";
