...
window.MobileSelect = (function() {
	...
	MobileSelect.prototype = {
		...
		init: function(config){
			...
			_this.checkCascade();
			if (_this.cascade) {
				_this.defaultsecond=config.value2 ? config.value2 : 0;
				//alert(_this.defaultsecond);
    			_this.initCascade(_this.defaultsecond);
				//_this.initCascade();
			}
			//瀹氫綅 鍒濆浣嶇疆
		...
		initCascade: function(defaultsecond){
			//alert(defaultsecond);
			var _this = this;
			_this.displayJson.push(_this.generateArrData(_this.jsonData));
			if(defaultsecond) {
				_this.checkArrDeep(_this.jsonData[defaultsecond]);
			}else{
